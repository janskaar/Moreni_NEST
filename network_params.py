...
net_dict = {
    ...
    "conn_probs": np.loadtxt(
        os.path.join("parameter_files", "connectivity.csv"), delimiter=","
    ),
    # taken from connectionsStren.txt, Csl1.txt, Cstol1.txt. L1->L1 found in simulation scripts.
    "weights": np.loadtxt(
        os.path.join("parameter_files", "synaptic_weights.csv"), delimiter=","
    ),
    "weight_scale": 5.0,
    "nu_ext": [ 650,
                930, 1460, 870, 1405,
    ...
    "neuron_params": {
        "E_L": [ -65.5,
                 -80.97, -82.35, -69.16, -67.94,
                 -72.53, -70.45, -74.2, -63.14,
                 -68.28, -77.5, -70.01, -72,
                 -77.5, -76.42, -62.99, -78.85 ],
        "V_th": [ -40.20,
                  -40.53, -56.32, -39.95, -41.34,
                  -47.63, -44.23, -44.07, -40.89,
                  -40.55, -51.2, -47.38, -51.2,
                  -42.31, -49.06, -37.19, -44.81 ],
        "V_reset": [ -65.5,
                    -80.97, -82.35, -69.16, -67.94,
                    -72.53, -70.45, -74.2, -63.14,
                    -68.28, -77.5, -70.01, -72,
                    -77.5, -76.42, -62.99, -78.85 ],
        "C_m": [ 37.11,
            123.41, 70.95, 82.34, 41.23,
            80.16, 81.21, 132.86, 40.3,
            149.43, 70.9, 52.32, 59.29,
            99.96, 49.65, 96.09, 65.87 ],
        "t_ref": [ 3.5,
            3, 1.26, 1.85, 2.75,
            4.4, 1.5, 2.2, 2.4,
            4.25, 1.85, 1.9, 2.55,
